      ...
      >
        <div className="w-full flex justify-center items-center">
          ...
          <div className={`w-full flex flex-col items-center gap-5`}>
            ...
            >
              Welcome to CoreVerse Battleground, a blockchain-based gaming world where strategy
              and skill meet innovation. In CoreVerse, players own and trade NFT
              items, engage in thrilling battles, and enhance characters with
              unique gear. The game’s token economy, powered by $Battlecoin, rewards
